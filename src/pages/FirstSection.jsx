...
const CenteredSvg = styled.svg`
  ...
  transform: translate(
    -50%,
    -40%
  ); // Adjust the second value to fine-tune the vertical position
      ...
      <MainSection>
        <FullPageContainer>
          ...
          <SvgContainer>
            ...
            <TextBelowSvg>Scroll More</TextBelowSvg>
          </SvgContainer>
          <BottomTextContainer>
            <BottomText>
              "We are here to bridge the communication gap between the blind,
              deaf, and mute."
            </BottomText>
          </BottomTextContainer>
        </FullPageContainer>
